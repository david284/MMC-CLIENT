    ...
    <q-card-section style="height: 120px" class="no-margin q-py-none">
      <div class="text-h6">{{ displayTitle }}
        <q-card-section style ="min-width: 10px; height: 10px" class="no-margin no-padding float-right text-caption text-weight-thin">
          &nbsp; {{ eventVariableIndexHigh }} : {{ eventVariableIndexLow }}
        </q-card-section>
      </div>
...
const props = defineProps({
  ...
  "eventVariableIndexHigh": {
    type: Number,
    required: true
  },
  "eventVariableIndexLow": {
    type: Number,
    required: true
  },
  "displayTitle": {
...
*/
  return (EventFunctions.getEventVariable(store, props.NodeNumber, props.eventIdentifier, props.eventIndex, props.eventVariableIndexHigh) <<8)
  + EventFunctions.getEventVariable(store, props.NodeNumber, props.eventIdentifier, props.eventIndex, props.eventVariableIndexLow)
})
