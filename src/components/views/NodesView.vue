...
const columns = [
  ...
  {name: 'moduleVersion', field: 'moduleVersion', required: true, label: 'Ver', align: 'left', sortable: true},
  ...
  {name: 'events', field: 'events', label: 'Events', align: 'center', sortable: true},
